...
<div class="orders-page">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4 mb-0">
        <div class="flex flex-col sm:flex-row gap-4">
            <div class="relative max-w-md flex-1 xl:flex-none">
                ...
                <input id="orderSearch" type="text" placeholder="Search orders, customers..." oninput="filterOrders()" class="w-full xl:w-sm pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent">
            </div>
