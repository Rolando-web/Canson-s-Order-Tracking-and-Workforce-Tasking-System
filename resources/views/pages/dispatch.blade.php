    ...
    <div class="space-y-4">
        <div class="bg-white rounded-xl border border-gray-200 p-6">
                 <div class="flex gap-3 justify-end mb-3">
                    <button class="flex items-center gap-2 px-2 py-2 border border-gray-300 rounded-lg text-xs md:text-sm font-medium text-gray-600 hover:bg-gray-50 transition-colors">
                        <svg class="w-2 h-2 md:w-4 md:h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6.72 13.829c-.24.03-.48.062-.72.096m.72-.096a42.415 42.415 0 0110.56 0m-10.56 0L6.34 18m10.94-4.171c.24.03.48.062.72.096m-.72-.096L17.66 18m0 0l.229 2.523a1.125 1.125 0 01-1.12 1.227H7.231c-.662 0-1.18-.568-1.12-1.227L6.34 18m11.318 0h1.091A2.25 2.25 0 0021 15.75V9.456c0-1.081-.768-2.015-1.837-2.175a48.055 48.055 0 00-1.913-.247"/></svg>
                        Print DR
                    </button>
                    <button class="flex items-center gap-2 px-4 py-2.5 bg-purple-600 hover:bg-purple-700 text-white rounded-lg text-xs md:text-sm font-medium transition-colors">
                        Mark Shipped
                        <svg class="w-2 h-2 md:w-4 md:h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3"/></svg>
                    </button>
                </div>
            <div class="flex gap-3 md:gap-6">
                    <div class="flex-none">
                        <h3 class="text-sm md:text-lg font-bold text-gray-900">St. Mary School</h3>
                    <p class="text-xs md:text-sm text-gray-500 mt-0.5">500 Data Filer Boxes</p>
                    <p class="flex items-center gap-1 text-xs md:text-sm text-gray-400 mt-1">
                        <svg class="w-4 md:h-4" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z"/></svg>
                        123 School Lane
                    </p>
                    </div>
            
                <div class="flex items-center grow justify-end gap-3 md:gap-8">
                        <span class="text-end px-2.5 py-1 rounded-full text-xs bg-emerald-50 text-emerald-600 border border-emerald-200">ORD-001</span>
